...
const StudentDashboard = () => {
    // Simulation d'identification (À adapter selon votre système d'authentification/Context/localStorage)
    const [user] = useState({
        id_utilisateur: 1, // id_utilisateur de l'étudiant connecté
        id_etudiant: 1,    // id_etudiant correspondant
        isDelegue: true    // Mettre à false si l'étudiant n'est pas délégué pour tester
    });
    ...
    const API_URL = 'http://localhost:5000/api/student'; // Remplacez par votre URL d'API
                            ...
                            <tbody>
                                {demandes.map((d) => (
                                    <tr key={d.id_demande}>
                                        ...
                                        <td style={{ border: '1px solid #ddd', padding: '8px' }}>{d.type_libelle}</td>
